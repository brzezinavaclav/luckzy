...
$server_seed = (int)$player['dice_seed'];
...
db_query("INSERT INTO `spins` (`player`,`bet_amount`,`server_seed`,`client_seed`,`result`,`multiplier`,`payout`, `game`) VALUES ($player[id],$wager,'".serialize($server_seed)."','$client_seed','".$result."',$multiplier,$payout, 'dice')");
...
db_query("UPDATE `players` SET `last_dice_seed`=`dice_seed`,`dice_seed`='$newSeed',`last_client_seed`=`client_seed`,`client_seed`='$newCSeed',`last_dice_result`='$result' WHERE `id`=$player[id] LIMIT 1");
