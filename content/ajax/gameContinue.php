...
echo json_encode(array('bet_amount'=>$gameData['bet_amount'],'dealer'=>$dealer,'player'=>$player_,'accessable'=>$gameData['accessable_actions'],'sums'=>array('player'=>$playerSums,'player2'=>$playerSums2)));
