    ...
    <tr>
        <td align="center" valign="top" bgcolor="#ffffff"  width="100%">
            ...
            <table cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <table cellspacing="0" cellpadding="0" width="600" class="w320">
                                <tr>
                                    <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center" width="270" style="background:#1f1f1f;padding:10px 10px 10px 20px;">
                                        <a data-click-track-id="9119" href="#" style="text-decoration:none;">
                            ...
                            <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                <tr>
                                    <td align="left" class="mobile-padding" style="padding:20px 20px 0">
                                        ...
                                        <h1>Welcome to Luckzy.com</h1>

                                        <br>
                                        We're excited you are here! You are one step from accessing Luckzy casino. Active your account by clicking the link below!
                                        <br>
                                        <br>
                                            ...
                                            <tr>
                                                <td style="width:130px;background:#D84A38;">
                                                    <div>
                                                        ...
                                                        <![endif]-->
                                                        <a href="#"
                                                           style="    border-bottom: 2px solid #278C0B; border-radius: 3px; background: #599b47;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;">Activate!</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]-->
                ...
                <tr>
                    <td valign="top" style="background-color:#1f1f1f;border-bottom:1px solid #e7e7e7;">
                        <table border="0" cellpadding="0" cellspacing="0" width="600" class="w320" style="margin: 0 auto;height:100%;color:#ffffff" bgcolor="#1f1f1f" >
                            <tr>
